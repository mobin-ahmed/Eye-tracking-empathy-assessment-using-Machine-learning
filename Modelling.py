...
## train test split
X_train, X_test, y_train, y_test=train_test_split(x, dtcnm_y, test_size=.2,random_state=40)
...
## train test split
X_train, X_test, y_train, y_test=train_test_split(xx, dttstm_y, test_size=.2,random_state=40)
